...
function Header({ showLanding, onBackToLanding, onShowAbout }) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-20 h-20 backdrop-blur bg-white/90 border-b border-gray-200">
        ...
        <div className="flex items-center justify-between h-full">
          ...
          <div onClick={onBackToLanding} role="link" aria-label="Go to homepage" className="flex items-center cursor-pointer select-none">
            ...
            <div className="text-left">
              <div className="text-lg lg:text-xl font-serif text-gray-900 leading-tight">
                AI Product Engineering Interview Guide
              </div>
              <div className="text-[11px] lg:text-xs text-gray-600 mt-0.5 hidden sm:block">
                500+ Questions • 13 Domains
              </div>
            </div>
          </div>
          ...
          <nav className="flex items-center space-x-2 sm:space-x-3">
            ...
            <button
              onClick={onShowAbout}
              className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 shadow-sm hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-slate-500"
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 shadow-sm hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
            ...
            <button
              onClick={handleShare}
              className="inline-flex items-center gap-2 rounded-full bg-slate-700 px-3 py-2 text-sm text-white shadow-sm hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500"
